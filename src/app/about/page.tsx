  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '40px 24px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ background: 'var(--bg-primary)', border: '0.5px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: '24px' }}>
          <h2 style={{ fontSize: 'var(--text-base)', fontWeight: 500, color: 'var(--text-primary)', marginBottom: 12 }}>Resources</h2>
        ...
        <div style={{ background: 'var(--bg-primary)', border: '0.5px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: '24px' }}>
          ...
          <p style={{ fontSize: 'var(--text-base)', color: 'var(--text-secondary)', lineHeight: 1.8 }}>
            LazyGrip.net is a community site, independently owned and operated, with no affiliation with or endorsement from Blizzard Entertainment, or from any other macro or sequence-building addon, including any addon the Workshop happens to be able to import from. It is not an official GRIP-EMS site. World of Warcraft is a trademark of Blizzard Entertainment, Inc.
          </p>
        </div>
