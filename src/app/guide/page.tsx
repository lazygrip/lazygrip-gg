...
export const metadata: Metadata = {
  ...
  keywords: ['GRIP-EMS guide', 'GRIP-EMS tutorial', 'how to use GRIP EMS', 'GRIP Enhanced Macro Sequencer guide', 'WoW rotation addon guide', 'WoW macro sequencer guide', 'Mythic+ macro guide', 'all specs macro guide', 'WoW sequence builder'],
}
  ...
  return (
    <div>
      ...
      <div style={{ padding: '14px 18px', background: 'var(--bg-primary)', border: '0.5px solid var(--border)', borderRadius: 'var(--radius-md)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <span style={{ fontSize: 12, color: 'var(--text-tertiary)' }}>Guide version: GRIP-EMS v2.1.20</span>
