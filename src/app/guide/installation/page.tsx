...
function Warning({ children }: { children: React.ReactNode }) {
  return (
    <div style={{
      display: 'flex',
      gap: 10,
      background: 'rgba(224,82,42,0.08)',
      border: '0.5px solid rgba(224,82,42,0.25)',
      borderRadius: 'var(--radius-md)',
      padding: '12px 14px',
      marginTop: 12,
      marginBottom: 4,
    ...
    <div>
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        <Step n={1} title="Download from CurseForge, Wago, or WoWInterface">
          <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7 }}>
            GRIP-EMS is free on all three platforms. Use whichever addon manager you already have — CurseForge app, Wago app, or a manual download.
          </p>
        ...
        <Step n={2} title="Enable the addon in-game">
          ...
          <Callout>
            If you don't see GRIP-EMS in the list, your addon manager didn't install it correctly. Try a manual download from one of the links above and drop the folder into your <Code>World of Warcraft\_retail_\Interface\AddOns</Code> directory.
          </Callout>
        </Step>
      </section>

      {/* Post-install — the critical part */}
      <section style={{ marginBottom: 40 }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: 20 }}>
          This is what most installation guides don't tell you. GRIP-EMS needs three specific WoW client settings to be correct before sequences will fire. None of them are set to the right value by default. If you skip this section and wonder why pressing your keybind does nothing, this is why.
        </p>
        ...
        <Step n={1} title="Fix your Cvar Health — the most important step">
          ...
          <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7, marginTop: 10 }}>
            Go to the <strong style={{ color: 'var(--text-primary)' }}>Cvar Health</strong> tab. You'll see a status indicator — if it's not green, click <strong style={{ color: 'var(--text-primary)' }}>Fix</strong>. That's it. The fix sets <Code>ActionButtonUseKeyDown</Code> to enabled.
          </p>
          <Warning>
            This is the single most common reason new users post "my keybind does nothing." Check this before anything else. It takes thirty seconds and solves the problem roughly half the time.
          </Warning>
        </Step>

        <Step n={2} title="Verify your SpellQueueWindow">
          <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7 }}>
            The SpellQueueWindow (SQW) controls how many milliseconds before a GCD ends WoW will accept your next cast. GRIP-EMS recommends a value between 100–400ms. Too low and spells clip. Too high and you get false casts queuing through.
          </p>
          <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7, marginTop: 10 }}>
            The Cvar Health tab shows your current value. If it's outside the recommended range the dashboard will flag it. Click Fix to apply the recommended setting.
          </p>
        </Step>

        <Step n={3} title="Set your click rate">
          <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7 }}>
            GRIP-EMS advances one step per keypress. Your hardware or software needs to send repeated keypresses at a consistent interval — this is your click rate. The right value depends on your setup but 150ms is a reliable starting point that works across most hardware and latency combinations.
          </p>
          <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7, marginTop: 10 }}>
            If you're using Razer hardware, set your repeat rate to 150ms in Synapse. If you're using a keyboard with software repeat, set it there. If you're just holding a key on a standard keyboard, WoW's key repeat rate applies — this is usually too slow for reliable sequence execution and you'll want to investigate a dedicated repeat solution.
          </p>
          <Callout>
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: 12 }}>
          GRIP-EMS does not put a button on your action bar. This trips up almost every new user who comes from GSE, which does create a draggable button that you place on a bar and bind.
        </p>
        <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: 12 }}>
          GRIP-EMS works differently — you bind a key directly to a sequence inside the addon, and the keybind fires the sequence without going through the action bar at all. There's nothing to drag. If you're looking for a button to appear and it isn't appearing, that's expected behavior, not a bug.
        </p>
        <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7 }}>
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {[
            ...
            'You\'re in Bear Form (or your spec\'s required form/stance) when testing',
          ].map((item, i) => (
            <div key={i} style={{
              display: 'flex',
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          {[
            ...
            { cmd: '/gems debug on', desc: 'Enables debug output to chat — useful when something isn\'t firing' },
